...
$sql = "SELECT * FROM remark_permission WHERE remark LIKE '%$searchKeyword%'";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        $html .= "<label for='permission_id'>Permission ID:</label><input type='text' id='remark-id' value='" . $row["permission_id"] . "' readonly>";
