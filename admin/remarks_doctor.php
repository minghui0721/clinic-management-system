...
<body>
    ...
    <form id="edit-remark-form">
        <input type="hidden" id="edit-remark-id" name="remark_id">
    ...
    <script>
        ...
        function fetchRemarks() {
            ...
            xhttp.open("GET", "fetch_remarks.php", true);
            xhttp.send();
        }
        ...
        document.getElementById("add-remark-form").addEventListener("submit", function(event) {
            ...
            xhttp.open("POST", "add_remark.php", true);
            xhttp.send(formData);
        });
        ...
        function deleteRemark(remarkId) {
            ...
            xhttp.open("GET", "delete_remark.php?remark_id=" + remarkId, true);
            xhttp.send();
        }
        
        function editRemark(remarkId, appointmentId, patientId, remark) {
            document.getElementById("edit-remark-id").value = remarkId;
        ...
        document.getElementById("edit-remark-form").addEventListener("submit", function(event) {
            ...
            xhttp.open("POST", "update_remark.php", true);
            xhttp.send(formData);
        });
        ...
        function fetchSearchResults(keyword) {
            ...
            xhttp.open("GET", "search_remarks.php?search=" + encodeURIComponent(keyword), true);
            xhttp.send();
        }
